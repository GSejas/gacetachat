...
#     def save_faiss_index(self, db, directory):
#         os.makedirs(directory, exist_ok=True)
#         db.save_local(directory)
        
#     def load_faiss_index(self, directory):
#         return FAISS.load_local(directory, self.embeddings)
...
class FAISSHelper:
    def __init__(self, model_name=None, max_tokens=None, temperature=None, openai_api_key=None):
    ...
    def load_faiss_index(self, directory):
        return FAISS.load_local(directory, self.embeddings, allow_dangerous_deserialization=True)
